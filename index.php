    ...
    case 'checkout':
      ...
      if (isset($_SESSION['s_user'])) {
        ...
        if (isset($_POST['btnpay'])) {
          ...
          $vnp_Returnurl = "http://localhost/suruchi/index.php?pg=checkout";
          ...
          $vnp_OrderInfo = 'Thanh Toán đơn hàng tại Suruchi';
          $vnp_OrderType = 'bank';
          $vnp_Amount = intval($sum) * 100;
          $vnp_Locale = 'vn';
          $vnp_BankCode = 'NCB';
          $vnp_IpAddr = 'http://localhost/suruchi/index.php?pg=checkout';
