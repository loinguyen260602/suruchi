        ...
        <div class="checkout__page--inner d-flex">
            <div class="main checkout__mian">
                <header class="main__header checkout__mian--header mb-30">
                    <h1 class="main__logo--title"><a class="logo logo__left mb-20" href="index.php"><img src="./view/assets/img/logo/logo2.jpg" alt="logo"></a></h1>
                ...
                <footer class="main__footer checkout__footer">
                    <p class="copyright__content">Bản quyền © 2023 <a class="copyright__content--link text__primary" href="index.php">BẠCH DƯƠNG</a> . Đã đăng ký Bản quyền.Thiết kế bởi BẠCH DƯƠNG</p>
                </footer>
            </div>
