            ...
            <div class="main checkout__mian">
                <header class="main__header checkout__mian--header mb-30">
                    <h1 class="main__logo--title">
                        <a class="logo logo__left mb-20" href="index.php"><img src="./view/assets/img/logo/logo2.jpg"
                                alt="logo"></a>
                    </h1>
                    <details class="order__summary--mobile__version">
                        <summary class="order__summary--toggle border-radius-5">
                            <span class="order__summary--toggle__inner">
                                ...
                                <span
                                    class="order__summary--final__price"><?=number_format($price,0,",",".")?>VNĐ</span>
                            </span>
                        </summary>
                    ...
                    <form action="index.php?pg=checkout" method="post">
                                ...
                                <div class="checkout__email--phone mb-12">
                                    <label>
                                        <input class="checkout__input--field border-radius-5"
                                            placeholder="Email hoặc số điện thoại" type="text" name="email"
                        ...
                        <div class="checkout__content--step section__shipping--address">
                            ...
                            <div class="section__shipping--address__content">
                                <div class="row">
                                    <div class="col-lg-6 mb-12">
                                        <div class="checkout__input--list ">
                                            <label>
                                                <input class="checkout__input--field border-radius-5"
                                                    placeholder="Họ và tên" type="text" name="name"
                                                    value="<?=$nameuser?>" required>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 mb-12">
                                        <div class="checkout__input--list">
                                            <label>
                                                <input class="checkout__input--field border-radius-5"
                                                    placeholder="Số điện thoại" type="text" name="sdt" value="<?=$sdt?>"
                                                    required>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="checkout__input--list">
                                            <label>
                                                <textarea class="reviews__comment--reply__textarea"
                                                    placeholder="Ghi chú" name="note" id="" cols="30"
                                                    rows="10"></textarea>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="checkout__checkbox">
                                    <input class="checkout__checkbox--input" type="radio" id="paypal" name="pttt"
                                        value="0">
                                    <span class="checkout__checkbox--checkmark"></span>
                                ...
                                <div class="checkout__checkbox">
                                    <input class="checkout__checkbox--input" type="radio" id="creditCard" name="pttt"
                                        value="1">
                                    <span class="checkout__checkbox--checkmark"></span>
                        ...
                        <div class="checkout__content--step__footer d-flex align-items-center">
                            <button class="continue__shipping--btn primary__btn border-radius-5" type="submit"
                                name="btnpay">Thanh toán</button>
                            <a class="previous__link--content" href="index.php?pg=cart">Quay lại giỏ hàng</a>
                        </div>
                    </form>
                </main>
                <footer class="main__footer checkout__footer">
                    <p class="copyright__content">Bản quyền © 2024 <a class="copyright__content--link text__primary"
                            href="index.php">Suruchi</a>. Đã đăng ký Bản quyền. Thiết kế bởi Bạch Dương</p>
                </footer>
            </div>
