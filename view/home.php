            ...
            <div class="row mb--n28">
                <div class="col-lg-5 col-md-order mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="index.php?pg=shop"><img class="banner__items--thumbnail__img" src="./view/assets/img/banner/bg-main3.jpg" alt="banner-img">
                            <div class="banner__items--content">
                                <span class="banner__items--content__subtitle">Giỏ hàng</span>
                                <h2 class="banner__items--content__title h3">Bộ sưu tập   <br/> BẠCH DƯƠNG</h2>
                ...
                <div class="col-lg-7 mb-28">
                    <div class="row row-cols-lg-2 row-cols-sm-2 row-cols-1">
                        <div class="col mb-28">
                            <div class="banner__items">
                                <a class="banner__items--thumbnail position__relative" href="index.php?pg=shop"><img class="banner__items--thumbnail__img" src="./view/assets/img/banner/banner7.png" alt="banner-img"> 
                                    <div class="banner__items--content">
                        ...
                        <div class="col mb-28">
                            <div class="banner__items">
                                <a class="banner__items--thumbnail position__relative" href="index.php?pg=shop"><img class="banner__items--thumbnail__img" src="./view/assets/img/banner/banner8.png" alt="banner-img"> 
                                    <div class="banner__items--content">
                    ...
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--max__height" src="./view/assets/img/banner/banner9.png" alt="banner-img"> 
                            <div class="banner__items--content">
                ...
                <div class="row row-cols-1 align-items-center">
                    <div class="col">
                        <div class="deals__banner--content position__relative">
                            <span style="color:white" class="deals__banner--content__subtitle text__secondary">Hãy nhanh tay để được giảm giá 25%</span>
            ...
            <div class="row row-cols-md-2 row-cols-1 mb--n28">
                <div class="col mb-28">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--max__height" src="./view/assets/img/banner/banner11.png" alt="banner-img">
                            <div class="banner__items--content">
                ...
                <div class="col mb-28">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--max__height" src="./view/assets/img/banner/banner12.png" alt="banner-img">
                            <div class="banner__items--content">
            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="banner__section--inner position__relative">
                        <a class="banner__items--thumbnail display-block" href="index.php?pg=shop"><img class="banner__items--thumbnail__img banner__img--height__md display-block" src="./view/assets/img/banner/bg-main.jpg" alt="banner-img">
                            <div class="banner__content--style2">
                                <h2 class="banner__content--style2__title text-white">BẠCH DƯƠNG?</h2>
                                <p class="banner__content--style2__desc">Bạn đang cần một chiếc đồng hồ vừa rẻ vừa chất lượng? Hãy đến ngay với chúng tôi!!!</p>
  ...
  (function(d, t) {
      ...
      v.onload = function() {
        window.voiceflow.chat.load({
          verify: { projectID: '6606166eca4539a7675c71fd' },
...
<script type="text/javascript">
  (function(d, t) {
      ...
      v.onload = function() {
        window.voiceflow.chat.load({
          verify: { projectID: '6634f45baf4386adfca19022' },
          url: 'https://general-runtime.voiceflow.com',
          versionID: 'production'
        });
      }
