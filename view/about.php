                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <h1 class="breadcrumb__content--title text-white mb-25">Về chúng tôi</h1>
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                <li class="breadcrumb__content--menu__items"><a class="text-white" href="index.php">Trang chủ</a></li>
                                <li class="breadcrumb__content--menu__items"><span class="text-white">Về chúng tôi</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about__thumb d-flex">
                            <div class="about__thumb--items">
                                <img class="about__thumb--img border-radius-5 display-block" src="./view/assets/img/other/tintuc10.jpg" alt="about-thumb">
                            </div>
        ...
        <section class="team__section section--padding">
            <div class="container">
                <div class="section__heading text-center mb-50">
                    <h2 class="section__heading--maintitle">Đội của chúng tôi</h2>
                </div>
        ...
        <section class="testimonial__section bg__gray--color section--padding">
            <div class="container-fluid">
                <div class="section__heading text-center mb-40">
                    <h2 class="section__heading--maintitle">Khách hàng của chúng tôi nói gì ?</h2>
                </div>
                ...
                <div class="shipping__section2--inner shipping__style3--inner d-flex justify-content-between">
                    <div class="shipping__items2 d-flex align-items-center">
                        ...
                        <div class="shipping__items2--content">
                            ...
                            <p class="shipping__items2--content__desc">Giao hàng nhanh</p>
                        </div>
                    </div>
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                        ...
                        <div class="shipping__items2--content">
                            ...
                            <p class="shipping__items2--content__desc">Nhiều hình thức thanh </p>
                        </div>
                    </div>
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                        ...
                        <div class="shipping__items2--content">
                            ...
                            <p class="shipping__items2--content__desc">Đổi trả hàng trong vòng 3 ngày</p>
                        </div>
                    </div>
                    <div class="shipping__items2 d-flex align-items-center">
                        <div class="shipping__items2--icon">
                        ...
                        <div class="shipping__items2--content">
                            ...
                            <p class="shipping__items2--content__desc">Hỗ trợ 24/24</p>
                        </div>
                    </div>
                </div>
            </div>
