...
<body>
    ...
    <header class="header__section">
        <div style="background-color: black;" class="header__topbar bg__secondary">
        ...
        <div class="main__header header__sticky" style="padding:10px 0;">
            <div class="container-fluid">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.php"><img class="main__logo--img" src="./view/assets/img/logo/logo2.jpg" style="width: 150px;;height:100px;" alt="logo-img"></a></h1>
                    </div>
